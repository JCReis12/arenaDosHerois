...
public class Jogo {
	...
	public static void main(String[] args) {
		...
		Personagem mago = new Mago ("Zaltor Chama Sombria");
		Personagem gigante = new Gigante ("Thorgrim Quebrador de Ossos");
		Personagem guerreiro = new Guerreiro ("Ragnar Rasga-Terras");
		Personagem arqueiro = new Arqueiro ("Kieran Olhos do Crepúsculo");
